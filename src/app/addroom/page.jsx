...
//                     onError={(e) => {
//                       e.target.src = "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=600&q=80"; // Fallback image if link is broken
//                     }}
//                   />
//                 ) : (
...
export default function AddRoomForm() {
  ...
  const onSubmit = async (e) => {
    ...
    // FormData-র বদলে সরাসরি রিঅ্যাক্ট স্টেট (formData) পাঠানো হলো 
    // এতে amenities সহ সব ডেটা নিখুঁতভাবে ব্যাকএন্ডে যাবে
